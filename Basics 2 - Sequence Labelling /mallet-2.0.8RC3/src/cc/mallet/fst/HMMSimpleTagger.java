...
public class HMMSimpleTagger
{
   ...
   *
   */
  public static class HMMSimpleTaggerSentence2FeatureSequence extends Pipe
  {
    // gdruck
     ...
     */
    public HMMSimpleTaggerSentence2FeatureSequence ()
    {
    ...
    public Instance pipe (Instance carrier)
    {
      ...
      FeatureSequence ret = new FeatureSequence(features, tokens.length);
...
//      carrier.setData(new FeatureVectorSequence(fvs));
  ...
  private static final CommandOption.Double gaussianVarianceOption = new CommandOption.Double
    (HMMSimpleTagger.class, "gaussian-variance", "DECIMAL", true, 10.0,
  ...
  private static final CommandOption.Boolean trainOption = new CommandOption.Boolean
    (HMMSimpleTagger.class, "train", "true|false", true, false,
     "Whether to train", null);

  private static final CommandOption.String testOption = new CommandOption.String
    (HMMSimpleTagger.class, "test", "lab or seg=start-1.continue-1,...,start-n.continue-n",
     true, null,
  ...
  private static final CommandOption.File modelOption = new CommandOption.File
    (HMMSimpleTagger.class, "model-file", "FILENAME", true, null,
  ...
  private static final CommandOption.Double trainingFractionOption = new CommandOption.Double
    (HMMSimpleTagger.class, "training-proportion", "DECIMAL", true, 0.5,
  ...
  private static final CommandOption.Integer randomSeedOption = new CommandOption.Integer
    (HMMSimpleTagger.class, "random-seed", "INTEGER", true, 0,
  ...
  private static final CommandOption.IntegerArray ordersOption = new CommandOption.IntegerArray
    (HMMSimpleTagger.class, "orders", "COMMA-SEP-DECIMALS", true, new int[]{1},
  ...
  private static final CommandOption.String forbiddenOption = new CommandOption.String(
      HMMSimpleTagger.class, "forbidden", "REGEXP", true,
  ...
  private static final CommandOption.String allowedOption = new CommandOption.String(
      HMMSimpleTagger.class, "allowed", "REGEXP", true,
  ...
  private static final CommandOption.String defaultOption = new CommandOption.String(
      HMMSimpleTagger.class, "default-label", "STRING", true, "O",
  ...
  private static final CommandOption.Integer iterationsOption = new CommandOption.Integer(
      HMMSimpleTagger.class, "iterations", "INTEGER", true, 500,
  ...
  private static final CommandOption.Boolean viterbiOutputOption = new CommandOption.Boolean(
      HMMSimpleTagger.class, "viterbi-output", "true|false", true, false,
  ...
  private static final CommandOption.Boolean connectedOption = new CommandOption.Boolean(
      HMMSimpleTagger.class, "fully-connected", "true|false", true, true,
  ...
  private static final CommandOption.Boolean continueTrainingOption = new CommandOption.Boolean(
      HMMSimpleTagger.class, "continue-training", "true|false", false, false,
  ...
  private static final CommandOption.Boolean includeInputOption = new CommandOption.Boolean(
          HMMSimpleTagger.class, "include-input", "true|false", true, false,
  ...
  private static final CommandOption.Boolean featureInductionOption = new CommandOption.Boolean(
          HMMSimpleTagger.class, "feature-induction", "true|false", true, false,
  ...
  /**
   * Create and train a HMM model from the given training data,
      ...
      boolean connected, int iterations, double var, HMM hmm)
  {
    ...
    if (hmm == null) {
      ...
      String startName =
        hmm.addOrderNStates(training, orders, null,
    ...
    boolean converged;
    /**
     * The following section, from the beginning to the end of the for loop
     * has been modified and commented to reduce training time for HMMs
     */
//  Lets just call the trainer once instead of several times
//  Hence remove the for loop altogether and call the trainer
//  with 'iterations' instead of 1
//	for (int i = 1; i <= iterations; i++) {
//    	converged = hmmt.train (training, 1);
		converged = hmmt.train (training, iterations);
...
//    hmm.train(training, null, testing, eval);
  ...
  /**
   * Command-line wrapper to train, test, or run a generic HMM-based tagger.
   *
  ...
  public static void main (String[] args) throws Exception
  {
    ...
    if (continueTrainingOption.value || !trainOption.value) {
      ...
      p = new HMMSimpleTaggerSentence2FeatureSequence();
    ...
    if (trainOption.value)
    {
      hmm = train(trainingData, testData, eval,
          ...
          gaussianVarianceOption.value, hmm);
      if (modelOption.value != null)
      {
    ...
    else
    {
      ...
      if (eval != null){
        ...
        for (int i = 0; i < testData.size(); i++)
        {
          ...
          Sequence[] outputs = apply(hmm, input, nBestOption.value);
