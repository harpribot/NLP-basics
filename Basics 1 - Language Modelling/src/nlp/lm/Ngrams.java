 ...
 * Common code collection for all the models.
 *
*/
...
public class Ngrams {
    ...
    public String start_marker = "<S>";
    public String end_marker = "</S>";
    ...
    public Ngrams() {
      	...
      	unigramMap.put(start_marker, new DoubleValue());
      	unigramMap.put(end_marker, new DoubleValue());
    ...
    public void trainSentence (List<String> sentence) {
      	...
      	String prevToken = start_marker;
      	DoubleValue unigramValue = unigramMap.get(start_marker);
      	...
      	unigramValue = unigramMap.get(end_marker);
      	unigramValue.increment();
      	tokenCount++;
      	// Account for end of sentence bigram
      	String bigram = bigram(prevToken, end_marker);
      	DoubleValue bigramValue = bigramMap.get(bigram);
      	if (bigramValue == null) {
      	    bigramValue = new DoubleValue();
      	    bigramMap.put(bigram, bigramValue);
    ...
    public double sentenceLogProb (List<String> sentence) {
      	...
      	DoubleValue unigramVal = unigramMap.get(end_marker);
      	String bigram = bigram(prevToken, end_marker);
      	DoubleValue bigramVal = bigramMap.get(bigram);
      	double logProb = Math.log(interpolatedProb(unigramVal, bigramVal));
